...
public class ASCIIArtGenerator {
    ...
    public void printText(String printText) throws Exception {
        ASCIIArtGenerator artGen = new ASCIIArtGenerator();
        System.out.println();
        artGen.printTextArt(printText,11, ASCIIArtFont.ART_FONT_MONO,"#");
        System.out.println();
    }
    ...
    private void printTextArt(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol) throws Exception {
        ...
        for (int y = 0; y < textHeight; y++) {
            ...
            if (sb.toString().trim().isEmpty())
                continue;
            System.out.println(BLACK_BOLD_BRIGHT+sb+ANSI_RESET);
        }
    }
